...
public class ConfigInfo {
    ...
    private String ams_url;  //ams地址
    private String act_url;  //act地址
    ...
    private String cloud_game_url;    // UMU: 云游戏链接
    ...
    public void setLock_pass(String lock_pass) {
        this.lock_pass = lock_pass;
    }
    ...
    public String getAct_url() {
        if (TextUtils.isEmpty(act_url)) {
            ...
            if (act_url.startsWith("http://") || act_url.startsWith("https://")) {
                return act_url;
            }
            return "https://" + act_url;
        }
    }
    ...
    public static void savaConfig(Context mContext, ConfigInfo config) {
        ...
        saveOrRemove(Pref.ACT_URL, config.getAct_url(), mContext);
        ...
        saveOrRemove(Pref.CLOUD_GAME_URL, config.getCloud_game_url(), mContext);
        saveOrRemove(Pref.AD_CYCLE, config.getAd_cycle(), mContext);
        ...
        saveOrRemove(Pref.LOCK_PASS, config.getLock_pass(), mContext);
        saveOrRemove(Pref.LOG_LEVEl, config.getLogLevel(), mContext);
        saveOrRemove(Pref.LOTTERY_URL, config.getLottery_url(), mContext);
        ...
        saveOrRemove(Pref.SHOW_MESSAGE_CENTER, config.getShow_message_center(), mContext);
    ...
    public String getCloud_game_url() {
        return cloud_game_url;
    }
    ...
    public void setCloud_game_url(String cloud_game_url) {
        this.cloud_game_url = cloud_game_url;
    }
    ...
    public String getShow_message_center() {
        return show_message_center;
    }

    public void setShow_message_center(String show_message_center) {
        this.show_message_center = show_message_center;
    }
}
