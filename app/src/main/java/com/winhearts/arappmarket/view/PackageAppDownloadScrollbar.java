...
/**
 * Description: 第三方app 打开的 进度条
 * Created by lmh on 2016/3/28.
 */
public class PackageAppDownloadScrollbar extends ProgressBar {
    private String text = "";
    private Paint mPaint;
    private int color = Color.WHITE;
    private Rect rect;

    public PackageAppDownloadScrollbar(Context context) {
        super(context);
        initText();
    }

    public PackageAppDownloadScrollbar(Context context, AttributeSet attrs) {
        super(context, attrs);
        initText();
    }

    public PackageAppDownloadScrollbar(Context context, AttributeSet attrs, int defStyle) {
