...
public class BlowUpUtil {
    private static float SCALE_FACTOR = 1.05f;
    private static float SCALE_FACTOR_2 = 1.08f;
    ...
    public void setIsBringToFront(boolean isBringToFront) {
