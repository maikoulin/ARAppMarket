...
class LogerImp implements Runnable{
        ...
        //时间格式
        private DateFormat format = new SimpleDateFormat("yyyy-MM-dd HH:mm:ss.SSS", Locale.getDefault());
...
//        }
        ...
        private void initPrint(){
                ...
                DateFormat dfm = new SimpleDateFormat("yyyy-MM-dd",Locale.getDefault());
                String fileName = dfm.format(date.getTime()) + ".txt";
                String path = null;
                try {
                        if (null != print){
                                close();
                        }
                        path = Environment.getExternalStorageDirectory().getAbsolutePath()+"/activity/";
